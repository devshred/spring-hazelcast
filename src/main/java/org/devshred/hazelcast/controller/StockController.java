...
public class StockController {
	...
	@RequestMapping("/")
	public ModelAndView listShares(final ModelMap model) {
	...
	public ModelAndView showShare(@PathVariable
		final String mic) {
	...
	public ModelAndView updateQuote(@PathVariable
		final String mic, @PathVariable
		final int quote) {
		final ModelAndView modelAndView = new ModelAndView("share/show");
